    ...
    <div className="min-h-screen bg-rail grid-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white">SendAnjal</h1>
          <p className="text-sm text-muted-foreground mt-1">WhatsApp Business Platform</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full wa-gradient text-primary-foreground font-semibold py-3 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-primary/25"
            >
              {loading ? (
